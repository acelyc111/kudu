...
TEST_F(HdrHistogramTest, MergeTest) {
  ...
  ASSERT_EQ(hist.ValueAtPercentile(99.0), lround(250 * 99.0 / 100));
  ASSERT_EQ(hist.ValueAtPercentile(95.0), lround(250 * 95.0 / 100));
  ASSERT_EQ(hist.ValueAtPercentile(50.0), lround(250 * 50.0 / 100));
}

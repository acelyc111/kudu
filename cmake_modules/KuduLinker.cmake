...
function(APPEND_LINKER_FLAGS)
  ...
  foreach(candidate_linker ${linkers})
    message(STATUS "candidate_linker: ${candidate_linker}")
...
function(GET_LINKER_VERSION)
  ...
  message("osx_sysroot: ${osx_sysroot}")
  message("ld_version_flag: ${ld_version_flag}")
  message("LINKER_STDERR: ${LINKER_STDERR}")
  message("LINKER_STDOUT: ${LINKER_STDOUT}")
  message("LINKER_EXITCODE: ${LINKER_EXITCODE}")
